...
setup(
    ...
    ext_modules=[
        Extension('gensim.models.word2vec_inner',
            ...
            library_dirs=['/usr/local/Cellar/gsl/1.16/lib', '/mounts/Users/cisintern/ryan/local/lib'],            
            include_dirs=[model_dir, '/usr/local/Cellar/gsl/1.16/include', '/mounts/Users/cisintern/ryan/local/include']),
